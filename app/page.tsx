  ...
  if (type === "book") {
    return (
      <div className="relative mx-auto h-36 w-48">
        <div className="orb left-2 top-4 h-28 w-28" />
        <div className="glass absolute bottom-2 left-8 h-24 w-32 rotate-[-8deg] rounded-[28px]" />
      </div>
    );
  }
  if (type === "pencil") {
    return (
      <div className="relative mx-auto h-36 w-52">
        <div className="orb right-0 top-0 h-24 w-24" />
        <div className="absolute bottom-10 left-4 h-12 w-44 rotate-[-12deg] rounded-full bg-gradient-to-r from-[#ff9d4d] via-[#ff7fae] to-white shadow-2xl" />
      </div>
    );
  }
  return (
    <div className="relative mx-auto h-36 w-48">
      <div className="glass absolute left-4 top-4 h-28 w-36 rounded-[34px]" />
      <div className="orb bottom-2 right-2 h-20 w-20" />
    </div>
  );
}
    ...
    <main className="min-h-screen">
      <header className="nav-glass">
        <div className="flex items-center justify-between gap-4 px-5 py-3">
          <a href="#top" className="text-lg font-black tracking-[-0.05em] text-[#0a1b39]">YOO SCHOOL</a>
      ...
      <section id="top" className="page-shell pb-8 pt-28 sm:pt-32">
        <div className="scene p-5 sm:p-8 lg:p-10">
          <div className="scene-content grid gap-8 lg:grid-cols-[0.88fr_1.12fr] lg:items-center">
            <div>
              <span className="badge">modern english school</span>
              <h1 className="h-display mt-6 max-w-[12ch] text-[#0f2a57]">Английский, который ощущается легко</h1>
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                {["Команда преподавателей", "Маршрут под цель", "Диагностика на старте"].map((item) => (
                  <div className="glass p-4 text-sm font-black text-[#19385f]" key={item}>{item}</div>
                ))}
              </div>
            </div>
            <div className="hero-art">
              ...
              <span className="orb left-[8%] bottom-[20%] h-20 w-20" />
              <span className="orb right-[10%] top-[18%] h-28 w-28" />
              ...
              <div className="glass absolute bottom-[8%] left-[8%] z-10 max-w-[280px] p-5">
                <p className="text-xs font-black uppercase tracking-[.12em] text-[#56769a]">learning route</p>
                <p className="mt-2 text-2xl font-black leading-[.95] tracking-[-.04em] text-[#0f2a57]">диагностика → маршрут → практика</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="directions" className="section page-shell">
        <div className="mb-8 grid gap-5 lg:grid-cols-[.7fr_1fr] lg:items-end">
          <div>
            <span className="badge">направления</span>
            <h2 className="h-section mt-5 max-w-4xl text-[#0f2a57]">Программы под разные цели</h2>
          </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {directions.map((item, index) => (
            <article className="glass feature-card flex flex-col" key={item.title}>
        ...
        <div className="scene mt-4 p-6 sm:p-8">
          <div className="scene-content grid gap-5 lg:grid-cols-[1fr_.55fr] lg:items-center">
            <div>
              <span className="badge">для компаний</span>
              <h3 className="h-section mt-5 max-w-4xl text-[#0f2a57]">Корпоративное обучение для команды</h3>
            ...
            <div className="relative min-h-[260px]">
              <span className="jelly-bear left-[18%] top-[8%]" />
              <span className="orb bottom-[8%] right-[10%] h-28 w-28" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="path" className="section page-shell">
        <div className="scene p-6 sm:p-8 lg:p-10">
          <div className="scene-content">
            ...
            <h2 className="h-section mt-5 max-w-4xl text-[#0f2a57]">Маршрут без хаоса и перегруза</h2>
            <div className="mt-8 grid gap-4 md:grid-cols-4">
              {path.map(([title, text], index) => (
                <div className="glass p-5" key={title}>
      ...
      <section className="section page-shell">
        <div className="mb-8 max-w-4xl">
          ...
          <h2 className="h-section mt-5 text-[#0f2a57]">Больше чем просто уроки</h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {ecosystem.map(([title, text]) => (
            <div className="glass p-6" key={title}>
              <span className="orb relative mb-8 block h-14 w-14" />
      ...
      <section className="section page-shell">
        <div className="grid gap-4 lg:grid-cols-[.9fr_1.1fr]">
          <div className="glass min-h-[520px] p-6 sm:p-8">
            <span className="badge">основатель</span>
            <h2 className="h-section mt-5 text-[#0f2a57]">Дарья Орлянская</h2>
          ...
          <div className="scene min-h-[520px] p-6 sm:p-8">
            <div className="scene-content max-w-xl">
              <span className="badge">method</span>
              <h3 className="h-section mt-5 text-[#0f2a57]">Методика, команда и личный подход</h3>
            ...
            <span className="inflatable-y bottom-[8%] right-[12%] top-auto scale-75" />
          </div>
        </div>
      </section>
      ...
      <section id="pricing" className="section page-shell">
        <div className="mb-8 max-w-4xl">
          ...
          <h2 className="h-section mt-5 text-[#0f2a57]">Формат подбираем после диагностики</h2>
        </div>
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
          {prices.map(([title, price, text], index) => (
            <article className={`glass price-card ${index === 0 ? "bg-white" : ""}`} key={title}>
              <span className="badge">0{index + 1}</span>
              <h3 className="mt-8 text-xl font-black leading-none text-[#13355f]">{title}</h3>
              <p className="mt-5 text-4xl font-black tracking-[-.07em] text-[#0f2a57]">{price}</p>
      ...
      <section id="faq" className="section page-shell">
        <div className="grid gap-8 lg:grid-cols-[.7fr_1.3fr]">
          <div>
            ...
            <h2 className="h-section mt-5 text-[#0f2a57]">Коротко о главном</h2>
          </div>
          <div className="grid gap-3">
            {faq.map(([q, a]) => (
              <details className="glass p-5" key={q}>
                <summary className="cursor-pointer text-lg font-black text-[#13355f]">{q}</summary>
      ...
      <section id="contact" className="page-shell pb-12">
        <div className="scene p-6 sm:p-8 lg:p-10">
          <div className="scene-content grid gap-6 lg:grid-cols-[.95fr_1.05fr] lg:items-center">
            <div>
              <span className="badge">start</span>
              <h2 className="h-section mt-5 max-w-4xl text-[#0f2a57]">Начните с бесплатного вводного урока</h2>
            ...
            <form className="glass grid gap-4 p-5 sm:p-7">
              ...
              <p className="text-sm font-bold text-[#49637f]">Telegram @yoo_school · +7 (900) 000-00-00</p>
            </form>
          </div>
        </div>
      </section>
      ...
      <footer className="page-shell pb-10">
        <div className="glass flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <p className="max-w-2xl text-sm font-bold text-[#49637f]">Английский для детей, подростков, взрослых и команд. Подбираем преподавателя, формат и маршрут обучения под цель ученика или бизнеса.</p>
        </div>
      </footer>
    </main>
  );
