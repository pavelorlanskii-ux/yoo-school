        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            <motion.h2
              ...
              className="mt-4 max-w-lg text-3xl font-bold text-white sm:text-4xl lg:text-5xl"
            >
              Начните свой путь к{" "}
            ...
            <div className="mt-8 space-y-3">
              <a
                ...
                className="inline-flex items-center gap-3 rounded-xl bg-white/10 px-5 py-4 text-base font-medium text-white transition hover:bg-white/15"
              >
